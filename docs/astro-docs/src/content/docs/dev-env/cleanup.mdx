...
cd ..
rm -rf agentcore-tech-summit-2025
...
### Step 7: Clean Package Caches (Optional)
...
If you encounter issues during cleanup, check the [Troubleshooting Guide](/faq/troubleshooting/) for cleanup-specific solutions, or contact workshop support through the designated Slack channel.
