---
title: 3. Production Readiness Assessment Section
description: Assess production readiness through cost analysis and security evaluation
---
...
Choose one or both activities to assess production readiness:
...
### 🔐 Security Assessment with AWS IaC MCP Server
...
"Using the AWS IaC MCP Server and AWS Knowledge MCP Server:
...
This activity gives you experience with:
...
### 🛡️ Implement Toxicity Detection Integration
